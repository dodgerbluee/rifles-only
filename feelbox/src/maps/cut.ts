...
function ramps(climb: Kit["climb"], box: BoxFn, mat: MatFn) {
  climb(-15.4, 4.0, "-x", 3.2, 2.6, 0, "lime");
  climb(-25.4, 8.0, "-x", 3.2, 2.6, 3.2, "lime");
  climb(8.0, 12.6, "+z", 3.2, 2.6, 0, "lime");
  climb(-12.5, 19.6, "+z", 3.2, 2.6, 3.2, "lime");
  climb(17.6, -3.0, "+x", 3.2, 2.4, 0, "lime");
  climb(19.2, 8.0, "+x", 3.2, 2.6, 0, "lime");
  climb(4.0, -8.6, "-z", 3.2, 2.6, 0, "lime");
  climb(-2.0, -15.4, "-z", 3.2, 2.6, 3.2, "lime");
