...
- **Sites** — `sites[]` take `w` / `d` for the plantable pad (default 6×6). The compiler draws a thin gold outline and a larger A/B letter; planting uses the rect, not a filled gold slab.
