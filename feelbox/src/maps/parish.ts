...
export function buildParish(scene: THREE.Scene): World {
  ...
  return finish(kit, {
    ...
    plantSpawns: [v(8, 29), v(7.2, 28.2), v(8.8, 28.2), v(8, 27.6), v(9, 29)],
    watchSpawns: [v(-6, -20), v(-4, -20), v(-2, -20), v(-6, -18), v(0, -18)],
    waypoints: [
      [v(-4, -14), v(-8, -8), v(-11, -8), v(-16, -8)],
      [v(-4, -14), v(2, -6), v(2, 4), v(2, 12), v(8, 18), v(8, 22)],
      [v(-4, -14), v(-12, 8), v(-12, 14), v(2, 16), v(8, 20)],
      [v(8, 28.4), v(8, 22), v(8, 18)],
      [v(8, 28.4), v(2, 16), v(-12, 8), v(-12, -8), v(-16, -8)],
      [v(8, 28.4), v(20, 28), v(20, 16), v(18, 4), v(18, -4), v(2, -8), v(-4, -10)],
...
function gardens(
  ...
  wallZ(box, mat, -10.0, -14.3, -1.8, h, [{ z0: -10.4, z1: -4.2, y0: 0, y1: 2.2 }], "brick");
  box(-16.1, h / 2, -14.25, 12.4, h, T, brick);
  box(-19.6, h / 2, -1.75, 5.2, h, T, brick);
  box(-13.8, h / 2, -1.75, 3.2, h, T, brick);
